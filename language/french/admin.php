 ...
 **
 ******************************************************************************/
define("_SnX_GB_DELETE","Effacer");
define("_SnX_GB_ACCEPT","Accepter");
define("_SnX_GB_ENTRIES_PER_PAGE", "Nombre de message par page");
define("_SnX_GB_NOTIFY_BY_EMAIL", "Quand nouveau message est post&eacute;, envoyer un mail &agrave;");
define("_SnX_GB_MODERATE", "Ce livre d'or est mod&eacute;r&eacute;");
define("_SnX_GB_DATE_FORMAT", "Format de date (<a href=\"http://fr.php.net/manual/fr/function.date.php\" target=_blank>aide</a>)");
define("_SnX_YES", "Oui");
define("_SnX_NO", "Non");
define("_SnX_GB_NO_MSG", "Aucun message &agrave traiter");
?>