...
define("_SnX_GB_DELETE","Delete");
define("_SnX_GB_ACCEPT","Accept");
define("_SnX_GB_ENTRIES_PER_PAGE", "Number of messages per page");
define("_SnX_GB_NOTIFY_BY_EMAIL", "Send an email when a new message is posted");
define("_SnX_GB_MODERATE", "This guestbook is moderated");
define("_SnX_GB_DATE_FORMAT", "Date format (<a href=\"http://fr.php.net/manual/en/function.date.php\" target=_blank>help</a>)");
define("_SnX_YES", "Yes");
define("_SnX_NO", "No");
define("_SnX_GB_NO_MSG", "No message to process");
?>