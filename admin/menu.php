...
$adminmenu[1]['title'] = _SnX_GB_ADMENU1;
$adminmenu[1]['link'] = "admin/index.php?op=msgmgr";
$adminmenu[2]['title'] = _SnX_GB_ADMENU2;
$adminmenu[2]['link'] = "admin/index.php?op=options";
$adminmenu[3]['title'] = _SnX_GB_ADMENU3;
$adminmenu[3]['link'] = "admin/index.php?op=moderation";
?>